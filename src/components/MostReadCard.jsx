...
export default function MostReadCard({ book }) {
  const fallbackImg = "https://via.placeholder.com/150x220?text=Kitob";
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col">
        ...
        {/* Muallif */}
        <p className="mt-1 text-sm font-medium text-[#5174ac] line-clamp-1">
          {book.author}
        </p>
        ...
        <div className="mt-4">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Kitob ikonasi (Ko'k) */}
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-4.5 w-4.5 text-[#1a56db]">
            ...
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-4.5 w-4.5 text-[#e02424]">
            ...
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-4.5 w-4.5 text-[#ff7b42]">
